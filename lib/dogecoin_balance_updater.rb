module DogecoinBalanceUpdater
  COIN = 100000000 # dogecoin/src/util.h
  ...
  def self.work
    Project.all.each do |project|
      ...
      count = 10
      loop do
        transactions = DogecoinDaemon.instance.list_transactions(project.address_label, count, start)
